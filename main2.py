...
# 引入了许多常用的库，如 torch、numpy、matplotlib 等，用于深度学习、数值计算、图形绘制等。 //pyglet==1.5.27
import torch
import numpy as np
...
import time
from sim_locate_method import locate_cars, get_rendered_image
...
if __name__ == "__main__":
    ...
    observe_agent = 0  # 设置需要观察的无人机序号，0表示全局模式，1-10分别为每个单独的无人车序号，-1表示无人机视野
    for i in range(300):
        ...
        if i % 15 == 0 and i != 0:
            try:
                ...
                filename = f"./loc_text/frame-{i}-@sec.png"
